...
<div style="background-size: 600px; background-image: url('media/computer1.png');" class="sub-container">
...
<div class="main-container-row">
	<div style="background-size: 1300px; background-image: url('media/computer4.jpg');" class="sub-container">
	<div class="sub-container-text">
